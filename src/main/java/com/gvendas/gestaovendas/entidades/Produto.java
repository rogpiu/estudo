...
public class Produto {
	...
	public Produto(String descricao, Integer quantidade, BigDecimal precoCurto, BigDecimal precoVenda,
	...
	public Produto(Long codigo, String descricao, Integer quantidade, BigDecimal precoCurto, BigDecimal precoVenda,
			String observacao, Categoria categoria) {
		this.codigo = codigo;
		this.descricao = descricao;
		this.quantidade = quantidade;
	...
	@Override
	public int hashCode() {
		return Objects.hash(categoria, codigo, descricao, observacao, precoCurto, precoVenda, quantidade);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(categoria, other.categoria) && Objects.equals(codigo, other.codigo)
				...
				&& Objects.equals(precoCurto, other.precoCurto) && Objects.equals(precoVenda, other.precoVenda)
